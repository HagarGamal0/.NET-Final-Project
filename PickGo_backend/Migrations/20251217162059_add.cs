    ...
    public partial class add : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, null, null, "11253b12-300f-469c-84b3-b9fd20a71914", "admin@gmail.com", true, null, false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAECylDE2vjyhAY0CjO559V79BmIqTVOJWoveHOIR6zB/pwk+1BUiwqLbGStIuHQLHOg==", null, false, "06473f43-81b1-46d0-a75c-f2d1b13aad45", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2584), "Basic package for couriers with 5 allowed orders", 0, 5, "Basic", 0m, "Courier" },
                    { 2, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2592), "Standard package for couriers with 10 allowed orders", 0, 10, "Standard", 50m, "Courier" },
                    { 3, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2595), "Premium package for couriers with 20 allowed orders", 0, 20, "Premium", 100m, "Courier" },
                    { 4, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2596), "Basic package for suppliers with 5 allowed orders", 0, 5, "Basic", 0m, "Supplier" },
                    { 5, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2597), "Standard package for suppliers with 10 allowed orders", 0, 10, "Standard", 50m, "Supplier" },
                    { 6, new DateTime(2025, 12, 17, 16, 20, 59, 252, DateTimeKind.Utc).AddTicks(2598), "Premium package for suppliers with 20 allowed orders", 0, 20, "Premium", 100m, "Supplier" }
                });
